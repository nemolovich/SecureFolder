...
public class TestZipUtils {
	...
	public void unExistingFile() throws ZipException, FileNotFoundException {
	...
	@Test
	public void secureExistingFolder() throws ZipException, FileNotFoundException {
		ZipUtils.secureFolder(new File(MainTestSuite.FILE_PATH
				+ File.separator + MainTestSuite.FOLDER_NAME), "test");
	}
